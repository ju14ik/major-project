	...
	<body>
        ...
        <div class="wrapper">
            ...
            <main class="recipe-details">
              ...
              <img src="../../images/snacks/cheese-and-meat-platter.jpg" alt="">
              
              <h2>You'll need:</h2>
              <ul>
                <li>Dry salami</li>
                <li>Prosciutto</li>
                <li>Low moisture, semi-firm/firm cheese: cheddar, aged Gouda, Manchego, Emmental, Gruyere</li>
                <li>Olives</li>
              ...
              <h2>On the trail:</h2>
              <ul>
                <li>Arrange all ingredients on a plate</li>
              </ul>
